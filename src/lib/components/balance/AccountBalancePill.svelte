...
<button
	type="button"
	class="bg-surface focus-visible:outline-focus flex w-full cursor-pointer items-center gap-2.5 rounded-lg border-2 px-2.5 py-2 text-start transition-[border-color] duration-200 ease-in-out focus-visible:outline-2 focus-visible:outline-offset-2 {selected
...
>
	...
	<span class="text-primary min-w-0 flex-1 truncate text-sm font-semibold">{label}</span>
